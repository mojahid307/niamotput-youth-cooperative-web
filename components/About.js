            ...
            <div className={styles.container}>
                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.text}>
                        <p>নিয়ামতপুর যুব সমবায় সমিতি লিঃ কাহালু থানার বগুড়া জেলার একটি সক্রিয় সমবায় সংগঠন। এই সমিতি এলাকার যুব সমাজের উন্নয়নে ও সমাজ গঠনে গুরুত্বপূর্ণ ভূমিকা পালন করে আসছে।</p>
